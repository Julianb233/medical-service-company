...
export default function LocationPageClient({ slug }: LocationPageClientProps) {
  ...
  const [yearsCount, yearsRef] = useCounter<HTMLDivElement>(20, { suffix: "+", duration: 2000 });
  const [caregiversCount, caregiversRef] = useCounter<HTMLDivElement>(500, { suffix: "+", duration: 2500 });
  const [ratingCount, ratingRef] = useCounter<HTMLDivElement>(5, { duration: 1500 });
