...
import { getSubareaBySlug, getSubareasForLocation } from "@/lib/subareas-data";
 ...
 * Creates 258 static pages (6 services × 43 locations)
...
/**
 * Generate SEO-optimized metadata for each location × service page
 * Includes location-specific keywords, zip codes, and local context
 */
...
/**
 * Location × Service page server component
 * Handles rendering for all 258 location-service combinations
 */
