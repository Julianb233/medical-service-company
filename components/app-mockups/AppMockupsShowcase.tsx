    ...
    <div className="w-full bg-gradient-to-br from-[#07162b] via-[#0b1f3b] to-[#07162b] py-16 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-12">
          ...
          <button
            onClick={prevScreen}
            className="hidden lg:flex w-14 h-14 bg-white/10 hover:bg-white/20 backdrop-blur-sm rounded-full items-center justify-center text-white transition-all duration-300 hover:scale-110"
        ...
        <div className="text-center mt-8">
          ...
          <div className="flex justify-center gap-4 lg:hidden mb-6">
            <button
              onClick={prevScreen}
              className="w-12 h-12 bg-white/10 hover:bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center text-white"
              aria-label="Previous screen"
            >
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center">
            ...
            <h4 className="text-white font-bold text-lg mb-2">Real-Time Updates</h4>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center">
            ...
            <h4 className="text-white font-bold text-lg mb-2">Family Connection</h4>
            <p className="text-gray-300 text-sm">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center">
            ...
            <h4 className="text-white font-bold text-lg mb-2">Health Insights</h4>
            <p className="text-gray-300 text-sm">
